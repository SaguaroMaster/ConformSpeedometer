...
ButtonCounterReset = Button(root, text = 'RESET COUNTER', font=('bold', 20), command = resetLength).grid(row=10,column=9, padx=(10,10), columnspan = 8)
ButtonAlarmReset = Button(root, text = 'RESET ALARM', font=('bold', 20), command = resetAlarm).grid(row=11,column=9, padx=(10,10), columnspan = 8)
