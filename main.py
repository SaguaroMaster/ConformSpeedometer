...
ButtonCounterReset = Button(root, text = 'RESET COUNTER', font=('bold', 20), command = resetLength, height = 2).grid(row=10,column=9, padx=(10,10), columnspan = 9)
ButtonAlarmReset = Button(root, text = 'RESET ALARM', font=('bold', 20), command = resetAlarm, height = 2).grid(row=11,column=9, padx=(10,10), columnspan = 9)
