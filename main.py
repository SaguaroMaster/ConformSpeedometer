...
def graphWindowCallback():
   ...
   CloseButton = Button(graphWindow, text = 'C L O S E', command = graphWindow.destroy, width = 10, height = 2, font = ('bold', 20))
   CloseButton.pack()
...
ButtonGraph = Button(root, text = 'GRAPH', font=('bold', 15), command = graphWindowCallback, height = 1, bg = UnlockButtonColor).grid(row=12,column=13, columnspan = 9)
