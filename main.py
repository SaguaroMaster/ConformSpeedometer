...
LengthTargetText = Label(root, text = 'ALARM SETTING: ', font=('bold', 30)).grid(row=5, column=1, pady=(15,15), columnspan = 2)
...
Plus10 = Button(root, text = '+10', font=('bold', 10), command = lambda: setLength(10), height = 5, width = 5).grid(row=11,column=5, padx=(10,10))
Plus100 = Button(root, text = '+100', font=('bold', 10), command = lambda: setLength(100), height = 5, width = 5).grid(row=11,column=4, padx=(10,10))
Plus1000 = Button(root, text = '+1000', font=('bold', 10), command = lambda: setLength(1000), height = 5, width = 5).grid(row=11,column=3, padx=(10,10))
Plus10000 = Button(root, text = '+10000', font=('bold', 10), command = lambda: setLength(10000), height = 5, width = 5).grid(row=11,column=2, padx=(10,10))
