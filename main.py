...
Unlock = Button(root, text = 'U  N  L  O  C  K', font=('bold', 25), command = unclockSetting, height = 1, width = 27, bg = UnlockButtonColor).grid(row=12,column=2, padx=(10,10), columnspan = 5)
